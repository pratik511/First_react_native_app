...
const Card = () => {
            ...
            <View style={{ backgroundColor: '#FBFCF8', borderRadius: 3, marginTop: 10, marginLeft: 17, marginRight: 17, borderWidth: 0.5 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ height: heigh1 }}>
                        <Text style={{ fontSize: 15, fontWeight: 'normal', color: 'black', marginLeft: 7, marginTop: 10 }}>{item.title}</Text>
    ...
    return (
        <View style={{ backgroundColor: '#fff', paddingBottom: 10, marginBottom: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: 'bold', color: 'black', paddingLeft: 5, margin: 8 }}>Hot Deals</Text>
            <View>
