...
import { StyleSheet, Text, View, FlatList, Dimensions, Image, Button, TouchableOpacity } from 'react-native';
        ...
        return (
            <View style={{ backgroundColor: '#FBFCF8', borderRadius: 3, marginTop: 10, marginLeft: 17, marginRight: 17, borderWidth: 0.5 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity style={{ marginTop: 18, marginRight: 10, borderRadius: 15, backgroundColor: 'blue', borderWidth: 1, width: 50, height: 30 }}>
                        <Text style={{ textAlign: 'center', marginTop: 3.5, color: "white" }}>Deal</Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
